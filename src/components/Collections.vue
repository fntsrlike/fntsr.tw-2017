  ...
  <div class="container" style="max-width:700px;">
    ...
    <section class="block">
      ...
      <ul>
        ...
        <li>Instance Link: <a target="_blank" href="http://compiler.oolab.fntsr.tw">http://compiler.oolab.fntsr.tw</a>
        <li>Language: Ruby</li>
      ...
      <div class="gallery">
        <a href="'../assets/images/ng_1_o.png'">
          <img class="screenshot" src="../assets/images/ng_1_o.png"/>
        </a>
        <a href="../assets/images/ng_2_o.png">
          <img class="screenshot" src="../assets/images/ng_2_o.png"/>
        </a>
        <a href="../assets/images/ng_3_o.png">
          <img class="screenshot" src="../assets/images/ng_3_o.png"/>
        </a>
        <a href="../assets/images/ng_4_o.png">
    ...
    <section class="block">
      ...
      <div class="gallery">
        <a href="../assets/images/sync_1_o.png">
          <img class="screenshot" src="../assets/images/sync_1_o.png"/>
        </a>
        <a href="../assets/images/sync_2_o.png">
    ...
    <section class="block">
      ...
      <ul>
        ...
        <li>Instance Link: <a target="_blank" href="http://app.nchusg.org/poster_manager">http://app.nchusg.org/poster_manager</a>
        <li>Language: PHP</li>
    ...
    <section class="block">
      ...
      <div class="gallery">
        <a href="../assets/images/appeal.jpg">
    ...
    <section class="block">
      ...
      <div class="gallery">
        <a href="../assets/images/nchusg_o.png">
    ...
    <section class="block">
      ...
      <ul>
        <li>Private</li>
        <li>Language: PHP</li>
        <li>Framework: Customize PHP MVC framework</li>
      </ul>
      <p>
      ...
      <div class="gallery">
        <a href="../assets/images/fss_o.png">
    ...
    <section class="block">
      ...
      <div class="gallery">
        <a href="../assets/images/rbs_o.png">
